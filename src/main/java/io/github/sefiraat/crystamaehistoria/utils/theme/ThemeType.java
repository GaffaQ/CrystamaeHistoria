...
public enum ThemeType {
    ...
    CRAFTING(ChatColor.of("#dbcea9"), "Crafting Materials"),
    CRYSTAL(ChatColor.of("#dbcea9"), "Magic Crystal"),
    MACHINE(ChatColor.of("#3295a8"), "Machine"),
    MECHANISM(ChatColor.of("#3295a8"), "Mechanism"),
    GADGET(ChatColor.of("#8732a8"), "Gadget"),
    EXALTED(ChatColor.of("#8732a8"), "Exalted Item"),
    ...
    CAST(ChatColor.of("#ffe138"), "Mold"),
    PART(ChatColor.of("#42c8f5"), "Part"),
    TOOL(ChatColor.of("#c2fc03"), "Tool"),
    STAVE(ChatColor.of("#c2fc03"), "Stave"),
    ARMOUR(ChatColor.of("#c2fc03"), "Armor"),
    INFO(ChatColor.of("#21588f"), "Info"),
    MOD(ChatColor.of("#bf307f"), "Mod"),
    PROP(ChatColor.of("#bf307f"), "Property"),
    ...
    RANK_BLOCK_EXPERT_OF(ChatColor.of("#0fff29"), "Expert"),
    RANK_BLOCK_MASTER_OF(ChatColor.of("#00db18"), "Master"),
    RANK_BLOCK_SME(ChatColor.of("#00820e"), "Historical Witness"),
    ...
    RANK_GILDING_CHIEF(ChatColor.of("#0fff29"), "Chief Executive"),
